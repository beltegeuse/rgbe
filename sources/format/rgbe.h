...
public:
  ...
  FormatRGBE(const std::string& path):
   Format(path)
  {
    read(path);
  }
...
void float2rgbe(unsigned char * rgbe, float red, float green, float blue) {
  float v;
  int e;
